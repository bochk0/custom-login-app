...
from app.config import CONNECT_WITH_, CONNECT_WITH_OIDC_ICON, OIDC_CLIENT_ID
...
def login():
    ...
    if form.validate_on_submit():
        ...
        if not user or not user.check_password(form.password.data):
            ...
            flash(
                "Your account is disabled. Please contact Login team to re-enable your account.",
                "error",
            )
